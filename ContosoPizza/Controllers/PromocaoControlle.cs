...
namespace ContosoPizza.Controllers
{
    ...
    public class PromocaoController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ServiceResponse<List<PromocaoResponseDto>>>> GetPromocao()
        {
            return Ok(await _PromocaoInterface.GetPromocao());
        }

        [HttpPost]
        public async Task<ActionResult<ServiceResponse<List<PromocaoResponseDto>>>> CreatePromocao(PromocaoCreateDto dto)
        {
